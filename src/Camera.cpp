...
Camera::Camera(glm::vec3 pos1, float t1, float p1): pos(pos1), theta(t1), phi(p1) {}
...
void Camera::usePerspective(GLint viewMatrixLocation, GLint projectionMatrixLocation, GLint cameraPostionLocation, float fov, float aspectRatio, float nearPlane, float farPlane){
